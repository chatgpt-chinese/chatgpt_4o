# 【ChatGPT 中文版】国内使用指南（支持GPT-4、4o 和 o1）【6月更新】
...
[ChatGPT 中文版](https://talk.lanjing.pro) 是 OpenAI 的 ChatGPT 模型的本地化版本，专门为中文用户设计，提供流畅、精准的对话体验。
...
|--------------------|----------------------------------|--------------------|----------|--------------------|---------|-------------------------|
| 一下AI            | [chat.yixiaai.com](https://talk.lanjing.pro/) | GPT-4、4o、o1      | 有       | 扫码即可       | 高      | 支持 AI绘画、AI助手、AI插件、AI PPT等  |
